...
pg.display.set_caption("Final Project Hangman")
...
images = {0:pg.image.load("imgs/empty.png"), 1:pg.image.load("imgs/v1.png"), 2:pg.image.load("imgs/v2.png"),
...
# English WOrd
wordsEN = ["GLOXINIA", "CRUEL SUN", "FULL COUNTER", "HELL BLAZE", "AUSTRALIA", "URUK", "WISDOM", "TRIAL", "MASSACRE", "HOLLOW"
           , "DISMANTLE", "SUNDER", "COURSERA", "LIGHT OF HEAVEN", "ALL FOR ONE", "SCORCH FLAME", "ALEXANDRE THE GREAT"
           , "ATILLA THE HUN", "TAKAEDA SHINGEN", "MEAT BALL"]
...
while True:
    ...
    if totalShown == len(currentLanguage[currentWord]) - spaceCount: # Winning Condition
        sounds["win"].play()
